...
class Config(BaseSettings):
    ...
    APP_PORT: int = 8000
    WRITER_DB_URL: str = "mysql+aiomysql://root:Pass%40123@localhost:3306/schole_test"
    READER_DB_URL: str = "mysql+aiomysql://root:Pass%40123@localhost:3306/schole_test"
